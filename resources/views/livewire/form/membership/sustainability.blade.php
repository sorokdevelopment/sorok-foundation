    ...
    <div x-data="{ open: false }">
        <ul class="space-y-4 text-sm sm:text-base leading-relaxed">
            <li>
                ...
                Help provide temporary shelter for persons affected by leprosy and families in street situations, giving them a safe space to rebuild while undergoing the Project New Life program.
            </li>
            <li>
                <i class="fa-solid fa-circle-check text-primary mr-2"></i>
            ...
            <template x-if="open">
                <div class="space-y-4 leading-relaxed">
                    ...
                    <li>
                        <i class="fa-solid fa-circle-check text-primary mr-2"></i>
                        Support capacity-building programs through training seminars and livelihood-focused skill-building workshops.
                    </li>
                    <li>
                        <i class="fa-solid fa-circle-check text-primary mr-2"></i>
                        Represent the mission with pride through exclusive Sorok Uni merchandise including a T-shirt, tote bag, and advocacy bracelet.
                    </li>
                    <li>
                        <i class="fa-solid fa-circle-check text-primary mr-2"></i>
                        Enjoy VIP access to Sorok Uni's most meaningful programs and milestone events-including the Sorok Short FilmFestival— where stories of hope and transformation come to life.
                    </li>
                    <li>
                        <i class="fa-solid fa-circle-check text-primary mr-2"></i>
                        Be honored at the annual Champions for Change Appreciation Event, celebrating passionate changemakers.
                    </li>
                    <li>
                        <i class="fa-solid fa-circle-check text-primary mr-2"></i>
