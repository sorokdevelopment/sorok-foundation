<x-layouts.app>
    <div>   
        ...
        <div class="bg-white border-b-4 md:border-l-6 md:border-b-0 border-[#00674F] md:rounded-r-lg md:max-w-2/3 mx-auto shadow-lg md:-mt-24 relative z-1">
        ...
        <x-layouts.container>
            <div class="py-12 mt-12 space-y-20 w-full flex flex-col justify-center items-center">
                ...
                <div class="grid w-full items-center gap-8 md:grid-cols-2">
                ...
                <div class="grid w-full items-center gap-8 md:grid-cols-2 md:grid-flow-dense">
                    ...
                    <div class="flex flex-col items-center justify-center space-y-8  md:col-start-1">
        ...
        <x-layouts.container>
            ...
            <div class="relative mt-12 lg:pb-24">
                ...
                <div class="lg:absolute space-y-8 xl:space-y-12 lg:right-0 lg:top-0  bg-[#00674F] text-white w-full lg:rounded-l-3xl lg:w-1/2 2xl:h-full py-12 lg:py-8 xl:py-12 px-6 sm:px-8 md:px-12 lg:px-16 shadow-lg">
